...
import 'package:tugas5/modules/spalsh_screen/splash_screen.dart';
...
class AppRoutes {
  ...
  static Page _newsDetailScreenHotBuilder(
    ...
    return const MaterialPage(
      child: NewsHotScreen(newsDetailHot: newsDetailHot),
    );
  }
